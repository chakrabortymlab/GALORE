...
## Part 1. Generate alignment file with MUMmer
...
## Part 2. Visualizing and interpreting dot plots

In Part 1, we aligned genomes using MUMmer, and the results were stored in a delta file. There are different ways to view this alignment:
...
# Part 3. Identify Structural Variants with SVMU
